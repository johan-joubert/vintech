<div class="row">
    <div class="col-md-12 text-center">
        ...
        <button type="button" class="btn btn-red mt-2 mb-2 text-center" style="width: 12rem" data-bs-toggle="modal" data-bs-target="#editDeliveryAddress">
            Modifier
        </button>
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('delivery-address.update', $user->deliveryAddress) }}" name="editDeliveryAddress">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" class="form-control" value="{{ $user->deliveryAddress->address }}" required>
