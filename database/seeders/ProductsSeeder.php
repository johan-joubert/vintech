...
// -------- PRODUITS DE LA GAMME GAMING ------------------------------------------------------------------------------
            DB::table('products')->insert(['name' => 'Borne d\'arcade DRAGON BALL',
            ...
            DB::table('products')->insert(['name' => 'Flipper STAR WARS',
            ...
            DB::table('products')->insert(['name' => 'NINTENDO NES',
            ...
            DB::table('products')->insert(['name' => 'SEGA MASTER SYSTEM',
            ...
            DB::table('products')->insert(['name' => 'GAME BOY',
            ...
            DB::table('products')->insert(['name' => 'GAME BOY COLOR POKÉMON',
            ...
            DB::table('products')->insert(['name' => 'TETRIS',
...
// -------- PRODUITS DE LA GAMME AUDIO ------------------------------------------------------------------------------        
            DB::table('products')->insert(['name' => 'Gramophone',
            ...
            DB::table('products')->insert(['name' => 'Platine vinyle',
            ...
            DB::table('products')->insert(['name' => 'Jukebox',
            ...
            DB::table('products')->insert(['name' => 'Chaine hifi',
            ...
            DB::table('products')->insert(['name' => 'Boombox',
            ...
            DB::table('products')->insert(['name' => 'Radio',
            ...
            DB::table('products')->insert(['name' => 'Walkman',
            ...
            DB::table('products')->insert(['name' => 'Baladeur CD',
            ...
            DB::table('products')->insert(['name' => 'Baladeur radio',
            ...
            DB::table('products')->insert(['name' => 'Lecteur MP3',
...
// -------- PRODUITS DE LA GAMME VIDEO ------------------------------------------------------------------------------
            DB::table('products')->insert(['name' => 'Téléviseur couleur',
            ...
            DB::table('products')->insert(['name' => 'Téléviseur sur pied',
            ...
            DB::table('products')->insert(['name' => 'Magnetoscope',
            ...
            DB::table('products')->insert(['name' => 'Camescope',
            ...
            DB::table('products')->insert(['name' => 'Vidéoprojecteur',
